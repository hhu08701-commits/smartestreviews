...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-900">Create Slide</h2>
</div>

<form method="POST" action="{{ route('admin.slideshow.store') }}" enctype="multipart/form-data" class="space-y-6">
    @csrf
