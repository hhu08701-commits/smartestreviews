...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-900">Create Hot Product</h2>
</div>

<form method="POST" action="{{ route('admin.hot-products.store') }}" enctype="multipart/form-data" class="space-y-6">
    @csrf
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="trending" id="trending" value="{{ old('trending', 0) }}" min="0"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('trending')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
